"""
Django settings for quiz_challenge project on Heroku. For more info, see:
...
ROOT_URLCONF = 'quiz_challenge.urls'
...
WSGI_APPLICATION = 'quiz_challenge.wsgi.application'
